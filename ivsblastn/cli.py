...
def build_parser() -> argparse.ArgumentParser:
    ...
    init_ref_parser.add_argument("--ref-unclear-per-genus", default=5, type=nonnegative_int, help="Maximum unclear-species records retained per genus, longest first. Use 0 to skip all unclear species. Default: 5.")
